...
public class ItemUtils {
	...
	public static ItemStack setTagStringItem(Pazaak plugin, ItemStack item, String key, String value) {
		return plugin.getNmsItemManager().setTagStringItem(item,key,value);
	}

	public static String getTagStringItem(Pazaak plugin, ItemStack item, String key) {
	...
	public static ItemStack removeTagItem(Pazaak plugin, ItemStack item, String key) {
		return plugin.getNmsItemManager().removeTagItem(item,key);
	}

	public static List<String> getNBT(Pazaak plugin, ItemStack item){
		return plugin.getNmsItemManager().getNBT(item);
	}

	public static ItemStack setNBT(Pazaak plugin, ItemStack item, List<String> nbtList){
	...
	public static void setSkullData(ItemStack item, CommonItemSkullData skullData, Player player){
		...
		if(serverVersion.serverVersionGreaterEqualThan(serverVersion,ServerVersion.v1_20_R2)){
			...
			PlayerProfile profile = Bukkit.createPlayerProfile(uuid,"pazaak");
			PlayerTextures textures = profile.getTextures();
			URL url;
			try {
	...
	public static List<String> getAttributes(Pazaak plugin, ItemStack item){
		if(OtherUtils.isLegacy()) {
	...
	public static ItemStack setAttributes(Pazaak plugin, ItemStack item, List<String> attributes) {
		if(attributes == null) {
			return item;
		}
	...
	public static void addDummyAttribute(ItemMeta meta, Pazaak plugin){
		try{
